                ...
                <div class="col-12">
                    <div class="bradcamb-content text-center text-white">
                        ...
                        <ul>
                            ...
                            <li><a href="{{ url('latest-job') }}"> Latest Jobs <span>//</span></a></li>
                            <li> {{ !empty($latest_job->title) ? $latest_job->title : '' }} </li>
                        </ul>
                    </div>
                </div>
            </div>
                                ...
                                <div class="blog bg-cat-2 mb-30 blog-res">
                                    <div class="blog__details links-card">
                                        <div class="card-heading">
                                            <h2>{{ !empty($latest_job->title) ? $latest_job->title : '' }}</h2>
                                        </div>
                                    </div>
                                    <div class="description p-5">
                                        {!! !empty($latest_job->description) ? $latest_job->description : '' !!}
                                    </div>
                                </div>
                            </div>
                        </div>
