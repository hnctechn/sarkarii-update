                ...
                <div class="col-12">
                    <div class="bradcamb-content text-center text-white">
                        ...
                        <ul>
                            ...
                            <li><a href="{{ url('answer-key') }}"> Answer Keys <span>//</span></a></li>
                            <li> {{ !empty($answer_key->title) ? $answer_key->title : '' }} </li>
                        </ul>
                    </div>
                </div>
            </div>
                                ...
                                <div class="blog bg-cat-2 mb-30 blog-res">
                                    <div class="blog__details links-card">
                                        <div class="card-heading">
                                            <h2>{{ !empty($answer_key->title) ? $answer_key->title : '' }}</h2>
                                        </div>
                                    </div>
                                    <div class="description p-5">
                                        {!! !empty($answer_key->description) ? $answer_key->description : '' !!}
                                    </div>
                                </div>
                            </div>
                        </div>
