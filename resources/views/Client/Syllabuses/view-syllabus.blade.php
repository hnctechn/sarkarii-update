                ...
                <div class="col-12">
                    <div class="bradcamb-content text-center text-white">
                        ...
                        <ul>
                            ...
                            <li><a href="{{ url('syllabus') }}"> Syllabus <span>//</span></a></li>
                            <li> {{ !empty($syllabus->title) ? $syllabus->title : '' }} </li>
                        </ul>
                    </div>
                </div>
            </div>
                                ...
                                <div class="blog bg-cat-2 mb-30 blog-res">
                                    <div class="blog__details links-card">
                                        <div class="card-heading">
                                            <h2>{{ !empty($syllabus->title) ? $syllabus->title : '' }}</h2>
                                        </div>
                                    </div>
                                    <div class="description p-5">
                                        {!! !empty($syllabus->description) ? $syllabus->description : '' !!}
                                    </div>
                                </div>
                            </div>
                        </div>
